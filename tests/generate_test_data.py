...
def generate_user_profiles():
    ...
    interests_by_category = {
        "development": [
            ...
            "full-stack", "javascript", "python", "react", "angular", "vue", 
            "node.js", "android", "ios", "cloud", "devops"
        ],
        "design": [
            "ui design", "ux design", "graphic design", "logo design", 
            "web design", "mobile design", "illustration", "branding"
        ],
        "content": [
            "content writing", "copywriting", "technical writing", "blog posts",
            "seo writing", "editing", "proofreading", "translation"
        ],
        "marketing": [
            "digital marketing", "social media", "seo", "sem", "email marketing",
            "content marketing", "growth hacking", "advertising"
        ],
        "business": [
            "business consulting", "project management", "financial analysis",
            "legal consultation", "hr consulting", "virtual assistance"
        ],
        "platform": [
            "payments", "hiring", "contracts", "proposals", "reviews", 
            "freelancer verification", "escrow", "fees", "invoicing"
        ]
    }
        ...
        for category in interests_by_category:
            if random.random() > 0.3:  # 70% chance to have interest in a category
                ...
                category_interests = random.sample(
                    ...
                    k=random.randint(1, n_interests)
                )
...
if __name__ == "__main__":
    ...
    print(f"Total items generated: {len(test_queries) + len(benchmark_queries) + len(user_profiles)}")