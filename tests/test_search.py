...
class TestSearchEngine:
    ...
    def test_enhance_talent_query(self, search_engine):
        ...
        frontend_query = search_engine._enhance_talent_query("Looking for a frontend engineer")
        ...
        exp_query = search_engine._enhance_talent_query("Need a developer with 5 years experience")
        ...
        senior_query = search_engine._enhance_talent_query("Senior Python developer needed")
    ...
    def test_analyze_intent(self, search_engine):
        ...
        hiring_intent = search_engine.analyze_intent("Need to hire someone who knows python")
        ...
        platform_intent = search_engine.analyze_intent("How does the payment system work?")
