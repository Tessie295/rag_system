...
class Settings(BaseSettings):
    ...
    LLM_MODEL: str = os.getenv("LLM_MODEL", "gpt-3.5-turbo")  # Use a faster model gpt-3.5-turbo-0125?
    EVALUATION_MODEL: str = os.getenv("EVALUATION_MODEL", "gpt-3.5-turbo")
    USE_LLM_FOR_EVALUATION: bool = os.getenv("USE_LLM_FOR_EVALUATION", "False").lower() in ("true", "1", "t")  # Disable by default for speed
